...
const cards = [
  ...
  },
  {
    ...
    img: "../img/desmartologista-card.png",
  },
];
...
export default function HealthPage() {
  ...
  return (
    <>
      <Navbar />
      <div className={`health-page ${darkMode ? "dark" : ""}`}>
        <img
          src="../img/logo servico.png"
          className="img-servicos"
          alt="Logo Serviços"
          data-aos="fade-down"
        />
        <h1 className="tittle-contato" data-aos="fade-right">
          Nossos Serviços
        </h1>
        <h1 className="team-title" data-aos="fade-left">
          Principais serviços da nossa rede
        </h1>
        ...
        <div className="team-section">
          <div className="image-container">
            {cards.map((card, index) => (
              <div
                key={card.id}
                className={`card-servico ${index % 2 === 0 ? "normal" : "reversed"}`}
                data-aos="fade-up"
              >
                ...
                <div className="content-servico">
                  ...
                  <button className="team-button" onClick={() => navigate("/agendamentos")}>
                    Agende Agora
                  </button>
                </div>
              </div>
