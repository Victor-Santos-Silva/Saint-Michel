...
import {
  ...
  FaFileAlt, FaUserPlus, FaSun, FaMoon
} from 'react-icons/fa';
...
function PerfilPage() {
  ...
  if (!userData) {
    return <div className={`carregando ${darkMode ? 'dark-mode' : ''}`}><p>Carregando...</p></div>;
  }

  return (
    <div className={`page-background ${darkMode ? 'dark-mode' : ''}`}>
      <div className={`perfil-container ${darkMode ? 'dark-mode' : ''}`}>
        ...
        {showDependentModal && (
          <div className={`modal ${darkMode ? 'dark-mode' : ''}`} onClick={() => setShowDependentModal(false)}>
            <div className={`modal-conteudo ${darkMode ? 'dark-mode' : ''}`} onClick={(e) => e.stopPropagation()}>
        ...
        {isEditing ? (
          <form
            className={`form-editar ${darkMode ? 'dark-mode' : ''}`}
            onSubmit={(e) => {
              e.preventDefault();
              salvarEdicao({
          ...
          <div className='perfil-visualizar'>
            <div className={`perfil-cartao ${darkMode ? 'dark-mode' : ''}`}>
              <div className='perfil-topo'>
                <img
                  src={userData.imagemGenero}
                  className='perfil-foto'
            ...
            <div className={`perfil-detalhes ${darkMode ? 'dark-mode' : ''}`}>
              <div className='secao'>
                <h3>Informações Pessoais</h3>
                <div className='detalhes-grade'>
                  <div className={`detalhe-item ${darkMode ? 'dark-mode' : ''}`}>
        ...
        <div className={`perfil-dependentes ${darkMode ? 'dark-mode' : ''}`}>
          <h3>Dependentes</h3>
